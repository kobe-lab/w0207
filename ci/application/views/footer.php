							...
							<div class="row">
								<div class="col-md-3">
									<div class="footer-content">
										<div class="logo-footer"><img id="logo-footer"src="<?=base_url('assets/template/images/logo_light_blue.png')?>" alt=""></div>
										...
										<div class="row grid-space-10">
											<div class="col-xs-6">
												<div class="overlay-container mb-10">
													<img src="<?=base_url('assets/template/images/product-1.jpg')?>" alt="">
											...
											<div class="col-xs-6">
												<div class="overlay-container mb-10">
													<img src="<?=base_url('assets/template/images/product-2.jpg')?>" alt="">
													<a href="portfolio-item.html" class="overlay-link small">
														<i class="fa fa-link"></i>
													</a>
												</div>
											...
											<div class="col-xs-6">
												<div class="overlay-container mb-10">
													<img src="<?=base_url('assets/template/images/product-3.jpg')?>" alt="">
													<a href="portfolio-item.html" class="overlay-link small">
														<i class="fa fa-link"></i>
													</a>
												</div>
											...
											<div class="col-xs-6">
												<div class="overlay-container mb-10">
													<img src="<?=base_url('assets/template/images/product-4.jpg')?>" alt="">
													<a href="portfolio-item.html" class="overlay-link small">
														<i class="fa fa-link"></i>
													</a>
												</div>
		...
		<script type="text/javascript" src="<?=base_url('assets/template/bootstrap/js/bootstrap.min.js')?>"></script>
		<!-- Modernizr javascript -->
		<script type="text/javascript" src="<?=base_url('assets/template/plugins/modernizr.js')?>"></script>
		...
		<!-- Isotope javascript -->
		<script type="text/javascript" src="<?=base_url('assets/template/plugins/isotope/isotope.pkgd.min.js')?>"></script>
		<!-- Magnific Popup javascript -->
		<script type="text/javascript" src="<?=base_url('assets/template/plugins/magnific-popup/jquery.magnific-popup.min.js')?>"></script>
		<!-- Appear javascript -->
		<script type="text/javascript" src="<?=base_url('assets/template/plugins/waypoints/jquery.waypoints.min.js')?>"></script>
		<!-- Count To javascript -->
		<script type="text/javascript" src="<?=base_url('assets/template/plugins/jquery.countTo.js')?>"></script>
		<!-- Parallax javascript -->
		<script src="<?=base_url('assets/template/plugins/jquery.parallax-1.1.3.js')?>"></script>
		<!-- Contact form -->
		<script src="<?=base_url('assets/template/plugins/jquery.validate.js')?>"></script>
		<!-- Background Video -->
		<script src="<?=base_url('assets/template/plugins/vide/jquery.vide.js')?>"></script>
		<!-- Owl carousel javascript -->
		<script type="text/javascript" src="<?=base_url('assets/template/plugins/owlcarousel2/owl.carousel.min.js')?>"></script>
		<!-- SmoothScroll javascript -->
		<script type="text/javascript" src="<?=base_url('assets/template/plugins/jquery.browser.js')?>"></script>
		<script type="text/javascript" src="<?=base_url('assets/template/plugins/SmoothScroll.js')?>"></script>
		<!-- Initialization of Plugins -->
		<script type="text/javascript" src="<?=base_url('assets/template/js/template.js')?>"></script>
		<!-- Custom Scripts -->
		...
		<script>
			...
			$.post("<?=base_url('addwishlistAPI')?>", {qty:1,product_id:pid}, function(result){
				console.log(result);
				result = JSON.parse(result);
				if(result.status == "OK") {
					alert("Add cart successfully");
